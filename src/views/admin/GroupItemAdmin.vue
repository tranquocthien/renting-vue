<template>
  <div>
    ...
    >
      ...
      <v-col
        cols="2"
        class="d-flex flex-column justify-center pt-2 pb-1"
      >
      ...
      <v-col cols="4" class="d-flex align-center pt-2 pb-1">
      ...
      <v-col cols="1" class="d-flex align-center justify-center pt-2 pb-1">
        <v-btn icon><v-icon small color="#98a6ad">preview</v-icon></v-btn>
        <v-btn icon><v-icon small color="#98a6ad">house</v-icon></v-btn>
      </v-col>
    </div>
    <!-- <div
      class="d-flex mx-4 align-center mb-0"
